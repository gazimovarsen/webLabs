...
from flask import render_template, make_response, request, Response, jsonify, json, url_for
...
def index3():
    ...
    #     second_message = request.form['message2']
        # return jsonify({'firstname': firstname, 'first_message': first_message, 'second_message': second_message})
